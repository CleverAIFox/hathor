...
| **다음 작업** | **O-36 실측 (D-0094).** 코드 풀에 `♭III`·`♭VI`·`♭VII`를 더했다 — **처음으로 생성기를 바꾼 개입이다.** 그런데 **넓히는 것만으로 거리가 오르므로**(합성에서 차용 없이도 0.2155→0.2696) 뭉치지 않는 세 칸을 같은 개수로 넣은 대조군과 견줘야 한다. `--compare-vocabulary` |
