...
| **다음 작업** | **O-36 마디 훑기 (D-0096).** 진단이 가설을 기각했다 — 차용 칸 분산이 대조 칸의 **1.49배**고 **극한이 +0.0208 앞선다.** 8마디에서 안 보이는 것은 **되튐 0.1270이 이득 0.0208을 6.1배로 덮기 때문**이다. 합성에서 8마디 44.7% · 256마디 101.4%. `--compare-vocabulary --bar-sweep 8,16,32,64,128` |
