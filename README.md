...
| **다음 작업** | **O-36 진단 하나 (D-0095).** 어휘를 넓혔더니 **칸이 늘어 공짜로 +0.0692가 오르고 차용이 번 몫은 +0.0063 · 승률 51%**로 동전 던지기다. **"뭉치면 중복" 가설은 세우고 기각했다.** 남은 가설은 **상관과 분산이 다른 양**이라는 것이고, 칸별 표준편차를 리포트에 넣었다 — 한 번 더 돌리면 갈린다 |
