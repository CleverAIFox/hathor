...
| **다음 작업** | **O-32 순서 조건화 (D-0097).** O-36이 닫혔다 — **차용 어휘는 출력을 더 가른다**(극한 대비 64마디 77.9%, 128마디 86.9%). **그리고 8은 마디 수가 아니라 섹션 수였다** — 파이프라인이 둘을 같은 것으로 쓰고 있었고 64마디로 고쳤다. **`MIXTURE`는 순서를 푼 뒤에 켠다** — `♭VII`는 자리가 곧 의미다 |
