...
| **다음 작업** | **O-31 재실측 (D-0087).** 도구에 결함이 둘 있었다 — 난수기 하나를 순서대로 써서 **선을 더하면 다른 선의 수가 밀렸고**, 귀무선을 **한 번만** 뽑았다. 둘 다 고쳤다(선별 독립 흐름 · 20회 반복 · 짝지은 표준오차). **D-0085의 표는 재현되지 않으며** 두 출처를 새로 돌려야 닫힌다 |
