...
| **다음 작업** | **O-36 어휘 확장 (D-0093).** O-35가 닫혔다 — **단조 차용이 실재한다**(뭉침 대비 +0.3787, t=12.81, 신뢰도 묶음 셋이 동일). 근거가 네 단계로 섰으므로 코드 풀에 `♭III`·`iv`·`♭VI`·`♭VII`를 더하고 **`eval harmony-output`으로 출력 차이를 다시 잰다** — 관측이 아니라 **개입**이다 |
