...
| **다음 작업** | **O-47 — 창이 원인이었다.** 박 뒤집힘이 4 / 39에서 **1 / 39**로 줄었다 (D-0171). 늘린 격자로 다시 잰다. **정본은 [`docs/PLAN.md`](docs/PLAN.md) §1이며 여기 다시 적지 않는다** (D-0130) |
...
리듬을 뽑으려면 박이 필요한데 그 박이 격자에 흔들린다 (O-47).
