...
| **다음 작업** | **O-31 재실측 (D-0086).** D-0085의 판정 근거가 무너졌다 — `실측 - within`의 **0점이 0이 아니라 +0.055**였고 실측 +0.037은 그보다 아래다. **거리의 44%를 버린다는 사실은 그대로**이나 "더 곡 고유하다"는 말은 못 한다. 등가선을 넣었고 다시 돌리면 닫힌다 |
