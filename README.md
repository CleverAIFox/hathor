...
| **다음 작업** | **O-33 (D-0088).** O-31이 닫혔다 — 다이어토닉 제한이 **거리의 44~47%를 버리고** 그 몫의 곡 고유성은 다이어토닉과 **대등하다**(초과 3%). **초과분은 전부 진짜 반음계 5칸에서 나오고 이끔음은 오히려 등가선 아래다.** 그 3%가 차용화음인지 조성 추정 오차인지 가르는 것이 다음이다 |
