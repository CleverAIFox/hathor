...
| **다음 작업** | **O-33 실측 (D-0089).** 도구는 섰다 — `eval chromatic-origin`. **역인과를 상관으로 못 뚫어 모양으로 뚫는다**: 조성 오차는 ♭7을 올리며 **이끔음을 지우고**(치환), 진짜 차용은 이끔음을 남긴다(첨가). 사전 벡터만 읽는다 |
...
**크로마 누설은 첨가를 흉내 낸다.** 배음·비브라토가 이웃 반음으로 번지면 ♭7과 이끔음이
함께 커진다. 이 도구는 그것을 차용과 못 가른다.
