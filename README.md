...
| O-49 잠재 표현 — **첫 조사 완료** (D-0180 · D-0181) | **`layer03`이 화성을 담는다** — P@10 0.2354로 MFCC 0.0665의 3.5배, 크로마 상한의 34%. **검색에 좋은 층과 화성을 담는 층이 다르다**(`layer00`은 여섯 중 꼴찌). **조건화는 O-63이 풀려야 돈다** |
