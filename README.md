...
| **다음 작업** | **O-32 재료 (D-0102).** 게이트를 통과했고(초과 0.2525, t=6.81) **순서 지표도 섰다** — 전이 행렬 거리, 현재 생성기에서 0.0000(음성 대조)·마르코프에서 0.1012(양성 대조). **남은 것은 크로마 시계열에서 마디별 화성을 뽑는 법**이고 고정 창인지 박자 추정인지 안 정했다 |
